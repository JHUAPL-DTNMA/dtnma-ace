...
class TestAriText(unittest.TestCase):
    ...
    def test_ari_text_decode_lit_typed_cbor(self):
        TEST_CASE = [
            ...
            "ari:/CBOR/h'A1%2064%2074%2065%2073%2074%2082%2003%20F9%2044%20%2080'", b"A164746573748203F94480")
        ]
    ...
    def test_ari_text_decode_lit_typed_rptset(self):
        TEST_CASE = [
            ...
            # FIXME: ("ari:/RPTSET/n=h'6869';r=/TP/725943845;(t=/TD/0;s=//example/test/CTRL/hi;(),"
            # FIXME:  "t=/TD/1;s=//example/test/CTRL/eh;())", 2), #ARI_PRIM_BSTR, 2),
        ]
